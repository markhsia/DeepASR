...
def test_DataOBJ(DataOBJ,example_fp,label_type='pinyin'):
    ...
    print(dataObj.get_label(label_type))
...
if __name__ == '__main__':
    for DataOBJ,example_fp in (
            ...
            (MagicData,"/data/speech/MAGICDATA/train/16_3634/16_3634_20170811100415.wav")
        ):
