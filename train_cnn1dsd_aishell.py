...
from Scripts.Models.CNN1d_CTC import CNN1d_CTC_PinYin_Sample_Dropout
...
if __name__ == '__main__':
    trainer = AcousticTrainer_OneData(
        ...
        label_type = 'pinyin',
        ModelOBJ = CNN1d_CTC_PinYin_Sample_Dropout,# !!!
        Model_name = 'CNN1d_CTC_PinYin_Sample_Dropout(AiShell)',# !!!
        epochs = 700,
    ...
    trainer.train_and_test(load_weight_path='saved_models/CNN1d_CTC_PinYin_Sample_Dropout(AiShell)/(gpu_n=1)(feature_name=mel)(label_type=pinyin)/best_val_loss(epoch=189)(val_loss=15).keras_weight')
